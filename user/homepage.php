...
<body>
    ...
    <section class="job-list" id="jobs">
        <div class="job-card" onclick="location.href='https://www.tesla.com/careers';">
            <div class="job-name">
                <a href="https://www.tesla.com">
                    <img class="job-profile" src="images/Tesla_logo.png" alt=""></a>
                <div class="job-detail">
                    <h4 class="link-xd"><a href="https://www.tesla.com">Tesla</h4></a>
                        <h3>Mechanical Engineer</h3>
                        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit.</p>
                </div>
            </div>
            <div class="job-label">
                <a class="label-a" href="https://en.wikipedia.org/wiki/HTML">HTML</a>
                <a class="label-b" href="https://en.wikipedia.org/wiki/CSS">CSS</a>
                <a class="label-c" href="https://en.wikipedia.org/wiki/JavaScript">JavaScript</a>
            </div>
            <div class="job-posted">
                Posted 2 mins ago
            </div>
        </div>
        <div class="job-card" onclick="location.href='https://jobs.ebayinc.com/us/en';">
            <div class="job-name">
                <a href="https://www.ebay.com/">
                    <img class="job-profile" src="images/ebaylogo.png" alt=""></a>
                <div class="job-detail">
                    <h4 class="link-xd"><a href="https://www.ebay.com/"> Ebay</h4></a>
        ...
        <div class="job-card" onclick="location.href='https://careers.google.com/?src=Online%2FHouse%20Ads%2FBKWS_Cloud_APAC';">
            <div class="job-name">
                <a href="https://about.google/">
                    <img class="job-profile" src="images/Google__G__Logo.svg.png" alt=""></a>
                <div class="job-detail">
                    <h4 class="link-xd"><a href="https://about.google/">Google</h4></a>
        ...
        <div class="job-card">
            <div class="job-name">
                <a href="https://about.instagram.com/">
                    <img class="job-profile" src="images/Instagram_logo_2016.svg.webp" alt=""></a>
                <div class="job-detail">
                    <h4 class="link-xd"><a href="https://about.instagram.com/">Instagram</h4></a>
        ...
        <div class="job-card">
            <div class="job-name">
                <a href="https://about.youtube/">
                    <img class="job-profile" src="images/youtubelogo.png" alt=""></a>
                <div class="job-detail">
                    <h4 class="link-xd"><a href="https://about.youtube/">YouTube</h4></a>
        ...
        <button class="jobs-more">More List</button>
    </section>-->
    <!--join-->
    <section class="join">
